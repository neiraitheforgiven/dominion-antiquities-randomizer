...
_Emptier = AdvTag("_Emptier")  # empties piles
_Empty = AdvTag("_Empty")  # cares about empty supply piles
_Emptier.bonusToTags = [_Empty]
_Empty.bonusToTags = [_Emptier]
_Exchange = AdvTag(
    "_Exchange"
...
_GainResponse3 = AdvTag(
    "_GainResponse3", bonusToTags=[_ExactGainer3, _Exchange, _Gainer3, _Gainer4, _Gainer5, _Gainer6,]
)  # Reaction triggered by gains.
_GainResponse4 = AdvTag(
    "_GainResponse4", bonusToTags=[_ExactGainer4, _Exchange, _Gainer4, _Gainer5, _Gainer6]
)  # Reaction triggered by gains.
...
Base.AddCards(
    [
        ...
        },
        {
            "name": "Cellar",
            "types": {Action},
            "advTags": {_Cantrip, _Cost2, _Discard, _Filler, _Sifter},
        },
        {
            "name": "Chapel",
            "types": {Action},
...
Intrigue.AddCards(
    [
        ...
        },
        {
            "name": "Lurker",
            "types": {Action},
            "advTags": {_Cost2, _Chainer, _Emptier, _Trasher, _TrashGainer},
        },
        {
            "name": "Masquerade",
            "types": {Action},
        ...
        },
        {
            "name": "Minion",
            "types": {Action, Attack},
            "advTags": {_BadSifter, _Chainer, _Choice, _Cost5, _Discard, _Money2, _Sifter},
        },
        {"name": "Nobles", "types": {Action, Victory}, "advTags": {_Choice, _Cost6, _Draw3, _Village}},
        {
            "name": "Patrol",
            "types": {Action},
        ...
        {"name": "Steward", "types": {Action}, "advTags": {_Choice, _Cost3, _Draw2, _Money2, _Terminal, _Thinner, _Trasher}},
        {
            "name": "Swindler",
            "types": {Action, Attack},
...
Seaside.AddCards(
    [
        ...
        },
        {
            "name": "Native Village",
            "types": {Action},
            "advTags": {_Cost2, _Drawload, _Saver, _Village},
        },
        {
            "name": "Outpost",
            "types": {Action, Duration},
        ...
        },
        {
            "name": "Sailor",
            "types": {Action, Duration},
            "advTags": {_Cost4, _GainResponse4, _Money2, _SpeedUp, _Thinner, _Trasher, _Village},
        },
        {
            "name": "Salvager",
            "types": {Action},
...
Alchemy.AddCards(
    [
        ...
        },
        {
            "name": "Herbalist",
            "types": {Action},
            "advTags": {_Buys, _Cost2, _DeckSeeder, _Money1, _Terminal},
        },
        {
...
Prosperity.AddCards(
    [
        ...
        },
        {
            "name": "Peddler",
            "types": {Action},
            "advTags": {_ActionLover, _Cost8, _CostVaries, _Peddler,},
        },
        {
            "name": "Quarry",
            "types": {Treasure},
...
Cornucopia.AddCards(
    [
        ...
        },
        {
            "name": "Tournament",
            "types": {Action},
            "advTags": {_Cost4, _Discard, _Interactive, _Peddler, _Prize, _VictoryGainer},
        },
        {
            "name": "Young Witch",
            "types": {Action, Attack},
...
Hinterlands.AddCards(
    [
        ...
        },
        {
            "name": "Oasis",
            "types": {Action},
            "advTags": {_Cost3, _Discard, _Peddler},
        },
        {
            "name": "Scheme",
            "types": {Action},
        ...
        },
        {
            "name": "Spice Merchant",
            "types": {Action},
            "advTags": {_Buys, _Cantrip, _Choice, _Cost4, _Draw2, _Money2, _Terminal, _Thinner, _Trasher},
        },
        {
            "name": "Stables",
            "types": {Action},
...
DarkAges.AddCards(
    [
        ...
        {"name": "Feodum", "types": {Victory}, "advTags": {_Cost4, _TrashGainer}},
        {
            "name": "Forager",
            "types": {Action},
            "advTags": {_Buys, _Chainer, _Cost3, _Payload, _Thinner, _Trasher},
        },
        {
            "name": "Fortress",
            "types": {Action},
        ...
        },
        {
            "name": "Rebuild",
            "types": {Action},
            "advTags": {_Chainer, _Cost5, _Discard, _Remodeler, _Reveal, _Trasher, _VictoryGainer},
        },
        {
            "name": "Rogue",
            "types": {Action, Attack},
...
Adventures.AddCards(
    [
        ...
        {"name": "Port", "types": {Action}, "advTags": {_Cost4, _GainResponse4, _Village}},
        {
            "name": "Ranger",
            "types": {Action},
...
Renaissance.AddCards(
    [
        ...
        },
        {
            "name": "Experiment",
            "types": {Action},
            "advTags": {_Cantrip, _Cost3, _Draw2, _GainResponse3},
        },
        {
            "name": "Flag Bearer",
            "types": {Action},
...
Menagerie.AddCards(
    [
        ...
        {"name": "Fisherman", "types": {Action}, "advTags": {_Cost3, _Cost5, _CostVaries, _Peddler}},
        {
            "name": "Gatekeeper",
            "types": {Action, Duration, Attack},
            "advTags": {
        ...
        },
        {
            "name": "Goatherd",
            "types": {Action},
            "advTags": {_Chainer, _Cost3, _Drawload, _Thinner, _Trasher},
        },
        {
            "name": "Groom",
            "types": {Action},
